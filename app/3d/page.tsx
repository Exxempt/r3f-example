...
export default function App() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-9" style={{ width: "100vw", height: `calc(100vh - 150px)`}}>
...
function Shoe({ random, color = new THREE.Color(), ...props }) {
  ...
  useFrame((state) => {
    ...
    ref.current.color.lerp(color.set(hovered ? 'green' : 'white'), hovered ? 1 : 0.1)
  })
  return (
    <group {...props}>
